...
class SexyNexusRS extends RenderScriptScene {
    ...
    public SexyNexusRS(int width, int height) {
        super(width, height);
    ...
    protected ScriptC createScript() {
        ...
        sb.setScript(mResources, R.raw.sexynexus);
    ...
    private void loadTextures() {
        mTextures[0] = loadTexture(R.drawable.dark_pyramid_background, "TBackground");
